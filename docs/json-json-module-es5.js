(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["json-json-module"], {
    ...
    /***/
    function srcAppEasyJsonJsonModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "JsonPageModule", function () {
        return JsonPageModule;
      });
      /* harmony import */
      ...
      var _json_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./json.page */
      ...
      var JsonPageModule = function JsonPageModule() {
        _classCallCheck(this, JsonPageModule);
      };

      JsonPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: JsonPageModule
      });
      JsonPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function JsonPageModule_Factory(t) {
          return new (t || JsonPageModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _header_header_module__WEBPACK_IMPORTED_MODULE_6__["HeaderPageModule"], _footer_footer_module__WEBPACK_IMPORTED_MODULE_7__["FooterPageModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
          path: '',
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](JsonPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](JsonPageModule, [{
    ...
    /***/
    function srcAppEasyJsonJsonPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "JsonPage", function () {
        return JsonPage;
      });
      /* harmony import */
      ...
      var _header_header_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../header/header.page */
      ...
      var _footer_footer_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../footer/footer.page */
      "./src/app/easy/footer/footer.page.ts");

      function JsonPage_pre_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function JsonPage_pre_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var JsonPage = /*#__PURE__*/function () {
        function JsonPage() {
          _classCallCheck(this, JsonPage);
        ...
        _createClass(JsonPage, [{
          ...
          value: function save() {
            if (this.nullCheck()) return;
            var datetime = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(Date.now(), 'MMddHHmmss', 'zh');
            var fileName = 'reallyEasy_' + datetime + '.json';

            var FileSaver = __webpack_require__(
            /*! file-saver */
            "./node_modules/_file-saver@2.0.5@file-saver/dist/FileSaver.min.js");

            var file = new File([this.jsonValue], fileName, {
      ...
      JsonPage.ɵfac = function JsonPage_Factory(t) {
        return new (t || JsonPage)();
      };

      JsonPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: JsonPage,
        selectors: [["app-json"]],
        decls: 22,
        vars: 5,
        consts: [[3, "fullscreen"], [1, "easy-ion-item"], ["id", "easy-json-textarea", "placeholder", "\u8BF7\u8F93\u5165\u9700\u8981\u8F6C\u6362\u7684json\u5B57\u7B26\u4E32...", "autofocus", "true", "inputmode", "text", 3, "rows", "ngModel", "ionFocus", "ngModelChange"], [3, "click"], ["color", "success", 3, "click"], ["color", "danger", 3, "click"], ["class", "easy-error-block", 4, "ngIf"], ["class", "easy-success-block", 4, "ngIf"], [1, "easy-error-block"], [1, "easy-success-block"]],
        template: function JsonPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionFocus", function JsonPage_Template_ion_textarea_ionFocus_6_listener() {
              return ctx.ionFocus();
            })("ngModelChange", function JsonPage_Template_ion_textarea_ngModelChange_6_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JsonPage_Template_ion_button_click_9_listener() {
              return ctx.format();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JsonPage_Template_ion_button_click_11_listener() {
              return ctx.copy();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JsonPage_Template_ion_button_click_13_listener() {
              return ctx.save();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JsonPage_Template_ion_button_click_15_listener() {
              return ctx.clear();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](JsonPage, [{
